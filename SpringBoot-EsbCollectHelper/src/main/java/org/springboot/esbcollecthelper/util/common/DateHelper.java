...
public class DateHelper {
	...
	public static void setSimpleFormat(SimpleDateFormat simpleFormat) {
		DateHelper.simpleFormat = simpleFormat;
	}
	
	public static void setSimpleFormat(String simpleFormat){
		DateHelper.simpleFormat = new SimpleDateFormat(simpleFormat);
	}
	
	public static void main(String[] args){
		DateHelper.setSimpleFormat("yyyy-MM-dd");
		System.out.println(DateHelper.getDayString(0));
	}
